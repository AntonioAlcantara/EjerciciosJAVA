...
// METODO CREAR LIBRO
    public static libro predeterminado_crear_libro(String titulo,String autor,String isbn,int num_ejem_tot,int num_ejem_pres) {
        ...
        milibro.setNum_ejem_tot(num_ejem_tot);
        milibro.setNum_ejem_pres(num_ejem_pres);
